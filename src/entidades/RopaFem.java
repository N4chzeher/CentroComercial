 ...
 */
public class RopaFem extends Local {
    private  String tipoLocal = "Tienda ropa femenina";
    private  float baseImpue = 0.9f;

    public RopaFem(){
    }

    public RopaFem(String nomLoal, String horario, int numEmpleados, float tamaño) {
