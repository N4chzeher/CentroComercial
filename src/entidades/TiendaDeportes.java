...
public class TiendaDeportes extends Local {
    private  String tipoLocal = "Tienda de deportes";
    private  float baseImpue = 1.4f;

    public TiendaDeportes(){
    }

    public TiendaDeportes(String nomLoal, String horario, int numEmpleados, float tamaño) {
